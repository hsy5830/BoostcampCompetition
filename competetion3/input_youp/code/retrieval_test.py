...
if __name__ == "__main__":
    ...
    # query = "부부가 딸을 차에 태운 곳은?"
    # query = "보닌의 흉터는 어디서 만들어졌을거라 추측되는가?"
    # query = '국부 제거술로 인한 환관지망생들의 사망률은?'
    # query = '히보코가 용서의 대가로 받은 물건은?'
    # query = '윤락행위등방지법이 전문 개정되었던 해는?'
